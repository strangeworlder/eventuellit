  ...
  render: () => (
    <MemoryRouter>
      <Grid cols={3} gap={4} className="p-6">
        <EntityCard
          name="Tuhkan puolue"
          subtitle="Yhteisöllinen vastaliike."
          color="primary"
          href="/world/faktiot/tuhkan-puolue"
        />
        <EntityCard
          name="KW-konsortio"
          subtitle="Suurkonsortio."
          color="secondary"
          href="/world/faktiot/kw-konsortio"
        />
        <EntityCard
          name="Ekklesia"
          subtitle="Teatterinen kirkko."
          color="accent"
          href="/world/faktiot/ekklesia"
        />
        <EntityCard
          name="Muotinvalajat"
          subtitle="Agitaattorit ja propagandistit."
          color="primary"
          parentLabel="Tuhkan puolue"
          variant="npc"
          href="/world/faktiot/muotinvalajat"
        />
        <EntityCard
          name="Heimolaiset"
          subtitle="Yhteisöllinen kasvuliike."
          color="primary"
          parentLabel="Tuhkan puolue"
          variant="npc"
          href="/world/faktiot/heimolaiset"
        />
        <EntityCard
          name="Erottajat"
          subtitle="Separatistit."
          color="primary"
          parentLabel="Tuhkan puolue"
          variant="npc"
          href="/world/faktiot/erottajat"
        />
        <EntityCard
          name="Ratasvartio"
          subtitle="Erikoisjoukot."
          color="secondary"
          parentLabel="KW-konsortio"
          variant="npc"
          href="/world/faktiot/ratasvartio"
        ...
        <EntityCard
          ...
          subtitle="Ideologinen siivousosasto."
          color="secondary"
          parentLabel="KW-konsortio"
          variant="npc"
          href="/world/faktiot/logiikan-inkvisitio"
        />
        <EntityCard
          name="Haaskalinnut"
          subtitle="Opportunistit."
          color="secondary"
          parentLabel="KW-konsortio"
          variant="npc"

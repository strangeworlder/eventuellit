  ...
  args: {
    ...
    children: (
      <p className="text-text/80">
        Hero näyttää taustakuvan, sisältää pikkukuvan suurennusta varten ja teksti pysyy luettavana
        peitekerroksen ansiosta.
      </p>
    ),
  },
};
...
export const WithBackgroundImageWithoutDescription: Story = {
  args: {
    ...
    children: (
      <p className="text-text/80">
        Tama nakyma varmistaa, etta minimikorkeus pysyy samana ilman kuvausta.
      </p>
    ),
  },
};

...
export interface TextAreaProps extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
  ...
  /** "compact" reduces padding, font size, and height to match the compact Input scale. */
      ...
      >
        ...
        <textarea
          ...
          className={cn(
            ...
            size === "default" && "px-4 py-3 text-[length:var(--font-size-lg)]",
            size === "compact" && "px-2.5 py-1 text-[length:var(--font-size-xs)] font-normal",

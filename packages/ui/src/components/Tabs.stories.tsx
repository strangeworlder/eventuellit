        ...
        <div className="w-full max-w-2xl bg-[var(--theme-bg)] text-[var(--theme-text)] p-8">
            <Tabs defaultValue="visuals">
                <TabsList>
                    ...
                    <TabsTrigger value="equipment" disabled>Equipment</TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="visuals">
                    <Card variant="subtle">
                        ...
                        <CardContent>
                            <p className="mb-4">Here you can configure how your character looks. Notice how the tab visually connects to the content area, resembling a classic binder organization system.</p>
                            <div className="h-24 w-24 bg-[var(--theme-secondary)]/20 border-2 border-[var(--theme-secondary)] rounded-full flex items-center justify-center">
                                <span className="text-sm font-bold uppercase tracking-widest text-[var(--theme-secondary)]">Avatar</span>
                            </div>
                        </CardContent>
                    </Card>
                </TabsContent>
                ...
                <CardContent>
                    <Tabs defaultValue="tabA">
                        ...
                        <TabsContent value="tabA">
                            <p className="mt-4 text-lg">Primary Dark Theme active. The colors seamlessly adapt.</p>
                        </TabsContent>

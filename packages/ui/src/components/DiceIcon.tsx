...
const DiceSvg = ({ faces, className, active }: { faces: number; className?: string; active?: boolean }) => {
    ...
    switch (faces) {
        case 4:
            return (
                <svg viewBox="0 0 100 100" strokeWidth="6" strokeLinejoin="round" className={className} style={style}>
        ...
        case 12:
            return (
                <svg viewBox="0 0 100 100" strokeWidth="6" strokeLinejoin="round" className={className} style={style}>
                    ...
                    <path d="M38 35 L25 13 M62 35 L75 13 M70 55 L95 64 M50 70 L50 95 M30 55 L5 64" fill="none" />
                </svg>
            );
        case 20:
            return (
                <svg viewBox="0 0 100 100" strokeWidth="6" strokeLinejoin="round" className={className} style={style}>
                    ...
                    <path d="M30 35 L50 5 M70 35 L50 5 M70 35 L95 27.5 M70 35 L95 72.5 M50 70 L95 72.5 M50 70 L50 95 M50 70 L5 72.5 M30 35 L5 72.5 M30 35 L5 27.5" fill="none" />
                </svg>
            );
        default:
            return null;
            ...
            >
                <DiceSvg
                    ...
                    className={cn(
                        ...
                        active ? "drop-shadow-[2px_2px_0px_color-mix(in_srgb,var(--theme-primary)_40%,transparent)]" : "drop-shadow-[2px_2px_0px_color-mix(in_srgb,var(--theme-secondary)_40%,transparent)]"
                    )}
                />
                <span className={cn(
                    "relative z-10",
                    active ? "text-[var(--theme-primary-foreground)]" : "text-[var(--theme-secondary-foreground)]"
                )}>
                    {value ?? faces}
                </span>
            </div>

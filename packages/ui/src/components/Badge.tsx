            ...
            <div
                ...
                className={cn(
                    "inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider transition-colors",
                    {
                        ...
                        "bg-[var(--theme-bg)] border-2 border-b-[var(--theme-secondary)] text-[var(--theme-secondary)]": variant === "outline",
                        "bg-[var(--theme-bg)] border-b-2 border-b-[var(--theme-accent)] text-[var(--theme-accent)]": variant === "highlight",

...
export const Variantit: Story = {
  render: () => (
    <div className="flex max-w-3xl flex-col gap-4">
      ...
      <Text variant="body">Perusteksti kuvaa tilanteen selkeasti ja neutraalisti.</Text>
      <Text variant="bold">Korostettu teksti nostaa esiin yhden tarkean huomiokohdan.</Text>
      <Text variant="muted">
      ...
      <div className="flex gap-6 items-start">
        <div className="flex flex-col items-center gap-1">
          <Text variant="node" className="text-center max-w-16">
            Lyhyt
          </Text>

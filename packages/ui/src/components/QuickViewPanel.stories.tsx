    ...
    return (
        <div className="p-6">
            ...
            <QuickViewPanel
                ...
                theme={props.theme}
                footer={props.footer ?? (
                    <Button variant="ghost-subtle" onClick={() => setOpen(false)}>Sulje</Button>
                )}
            >
                {props.children ?? (
                    <Stack direction="column" gap={4}>
                        ...
                        <Text>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Kynnyksen kanavilla liikkuu paljon sellaisia, joista on parempi pysyä erossa.</Text>
                    </Stack>
                )}
            </QuickViewPanel>
        </div>

    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <Text>
                        Oletko varma, että haluat jatkaa? Tätä toimintoa ei voi peruuttaa.
                    </Text>
                </Dialog>
            </>
        );
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <Text>
                        Hahmon <strong>Veera Mäkinen</strong> kaikki tiedot, taidot ja historia
                        poistetaan. Tietoja ei voida palauttaa poistamisen jälkeen.
                    </Text>
                </Dialog>
            </>
        );
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <Text>
                        Kampanja <strong>Kynnys – Kausi 1</strong> ja kaikki siihen liittyvät hahmot,
                        episodit ja tapahtumat poistetaan pysyvästi.
                    </Text>
                </Dialog>
            </>
        );
    ...
    render: () => {
        ...
        return (
            <div className="flex flex-wrap gap-3">
                ...
                >
                    <Text>
                        Tämä dialogi käyttää kokoa <strong>{activeSize ?? "md"}</strong>. Käytä
                        suurempia kokoja runsaalle sisällölle, pieniä lyhyille vahvistusikkunoille.
                    </Text>
                </Dialog>
            </div>
        );
    ...
    render: () => {
        ...
        return (
            <>
                ...
                >
                    <Text>
                        Taustahistoriasi määrittää aloitusvoimavarasi. Valinta on pysyvä.
                    </Text>
                </Dialog>
            </>
        );

  ...
  (() => {
    ...
    var Tn = __STORYBOOK_API__,
      {
        ...
        eventToShortcut: Ln,
        experimental_MockUniversalStore: In,
        experimental_UniversalStore: Dn,
        experimental_requestResponse: Mn,
        experimental_useUniversalStore: Pn,
        isMacLike: Bn,
        isShortcutTaken: Fn,
        keyToSymbol: zn,
        merge: Hn,
        ...
        shortcutMatchesShortcut: kn,
        shortcutToHumanString: Gn,
        types: Ae,
        useAddonState: Ce,
        useArgTypes: Wn,
        useArgs: Vn,
    ...
    var na = __STORYBOOK_CORE_EVENTS__,
      {
        ...
        ARGTYPES_INFO_RESPONSE: oa,
        CHANNEL_CREATED: ia,
        CHANNEL_WS_DISCONNECT: sa,
        CONFIG_ERROR: la,
        CREATE_NEW_STORYFILE_REQUEST: ua,
        CREATE_NEW_STORYFILE_RESPONSE: ca,
        CURRENT_STORY_WAS_SET: pa,
        DOCS_PREPARED: fa,
        DOCS_RENDERED: da,
        FILE_COMPONENT_SEARCH_REQUEST: ma,
        FILE_COMPONENT_SEARCH_RESPONSE: ga,
        FORCE_REMOUNT: ba,
        FORCE_RE_RENDER: ha,
        GLOBALS_UPDATED: Ea,
        NAVIGATE_URL: ya,
        PLAY_FUNCTION_THREW_EXCEPTION: Oa,
        PRELOAD_ENTRIES: Ta,
        PREVIEW_BUILDER_PROGRESS: _a,
        PREVIEW_KEYDOWN: va,
        REGISTER_SUBSCRIPTION: Sa,
        REQUEST_WHATS_NEW_DATA: Ra,
        RESET_STORY_ARGS: Aa,
        RESULT_WHATS_NEW_DATA: Ca,
        SAVE_STORY_REQUEST: Na,
        SAVE_STORY_RESPONSE: wa,
        SELECT_STORY: xa,
        SET_CONFIG: La,
        ...
        SET_INDEX: Pa,
        SET_STORIES: Ba,
        SET_WHATS_NEW_CACHE: Fa,
        SHARED_STATE_CHANGED: za,
        SHARED_STATE_SET: Ha,
        STORIES_COLLAPSE_ALL: Ua,
        STORIES_EXPAND_ALL: ja,
        STORY_ARGS_UPDATED: ka,
        STORY_CHANGED: k,
        STORY_ERRORED: Ga,
        STORY_FINISHED: Wa,
        STORY_INDEX_INVALIDATED: Va,
        STORY_MISSING: $a,
        STORY_PREPARED: Ya,
        STORY_RENDERED: Ja,
        STORY_RENDER_PHASE_CHANGED: qa,
        STORY_SPECIFIED: Xa,
        STORY_THREW_EXCEPTION: Za,
        STORY_UNCHANGED: Ka,
        TELEMETRY_ERROR: Qa,
        TESTING_MODULE_CANCEL_TEST_RUN_REQUEST: eo,
        TESTING_MODULE_CANCEL_TEST_RUN_RESPONSE: to,
        TESTING_MODULE_CRASH_REPORT: ro,
        TESTING_MODULE_PROGRESS_REPORT: no,
        TESTING_MODULE_RUN_ALL_REQUEST: ao,
        TESTING_MODULE_RUN_REQUEST: oo,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: io,
        UNHANDLED_ERRORS_WHILE_PLAYING: so,
        UPDATE_GLOBALS: lo,
        UPDATE_QUERY_PARAMS: uo,
        UPDATE_STORY_ARGS: co,
      } = __STORYBOOK_CORE_EVENTS__;
    var bo = __STORYBOOK_COMPONENTS__,
      {
        A: ho,
        ActionBar: we,
        AddonPanel: Eo,
        ...
        codeCommon: yi,
        components: Oi,
        createCopyToClipboardFunction: Ti,
        getStoryHref: _i,
        icons: vi,
        interleaveSeparators: Si,
    ...
    function L(e, t) {
      ...
      if (e && t && (r = e.constructor) === t.constructor) {
        ...
        if (r === Set) {
          ...
          for (n of e)
            if (((a = n), (a && typeof a == "object" && ((a = Me(t, a)), !a)) || !t.has(a)))
              return !1;
          return !0;
        }
        if (r === Map) {
          ...
          for (n of e)
            if (
              ((a = n[0]),
              (a && typeof a == "object" && ((a = Me(t, a)), !a)) || !L(n[1], t.get(a)))
            )
              return !1;
          return !0;
        }
        ...
        if (!r || typeof e == "object") {
          n = 0;
          for (r in e)
            if ((De.call(e, r) && ++n && !De.call(t, r)) || !(r in t) || !L(e[r], t[r])) return !1;
          return Object.keys(t).length === n;
        }
      }
      return e !== e && t !== t;
    }
    var Bi = __STORYBOOK_THEMING__,
      {
        CacheProvider: Fi,
        ClassNames: zi,
        Global: Hi,
    ...
    var lt = (t) => (r, n) => {
        ...
        var a = r,
          i = n;
        if (typeof r == "string") {
          if (!Ue(r, "px")) throw new _(69, t, r);
          a = je(r);
        }
        if (typeof n == "string") {
          if (!Ue(n, "px")) throw new _(70, t, n);
          i = je(n);
        }
    ...
    var kt = Object.create,
      ...
      fe = (e, t) => () => (t || (0, e[Ze(e)[0]])((t = { exports: {} }).exports, t), t.exports),
      $t = (e, t) => {
      ...
      Yt = (e, t, r, n) => {
        if ((t && typeof t == "object") || typeof t == "function")
          for (const a of Ze(t))
            !Vt.call(e, a) &&
              a !== r &&
              pe(e, a, { get: () => t[a], enumerable: !(n = Gt(t, a)) || n.enumerable });
        return e;
      },
      Jt = (e, t, r) => (
        (r = e != null ? kt(Wt(e)) : {}),
    ...
    var fr = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      vr = (e) => o.createElement(tt, { nodeRenderer: Tr, dataIterator: _r, ...e }),
      Sr = de(vr),
      Rr = Jt(Zt()),
      Ar = ({ table: e = !1, data: t, ...r }) =>
        e
      ...
      wr = B.div({ flex: 1, padding: "0 0 0 5px" }),
      xr = ({ children: e, className: t }) =>
        o.createElement(Le, { horizontal: !0, vertical: !0, className: t }, e),
      Lr = B(xr)({ margin: 0, padding: "10px 5px 20px" }),
      Ir = Pe(({ theme: e, ...t }) =>
        o.createElement(Ar, { theme: e.addonActionsTheme || "chromeLight", table: !1, ...t }),
      ),
          ...
          o.createElement(
            ...
            e.map((r) =>
              o.createElement(
                Cr,
                { key: r.id },
                r.count > 1 && o.createElement(Nr, null, r.count),
                o.createElement(
                  wr,
                  null,
                  o.createElement(Ir, {

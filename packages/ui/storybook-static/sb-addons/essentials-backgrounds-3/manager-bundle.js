try {
  (() => {
              ...
              (r, c, h) => {
                ...
                c.exports = (i) => {
                  ...
                  return (S) => {
                    var m = function () {
                      ...
                      for (O = 0; O < k; O++) {
                        if (((E[O] = { cacheItem: g, arg: arguments[O] }), g.has(arguments[O]))) {
                          g = g.get(arguments[O]);
                          continue;
                        }
                        (v = !1), (b = new s(!1)), g.set(arguments[O], b), (g = b);
                      }
                      return (
                        v && (g.has(arguments[k]) ? (B = g.get(arguments[k])) : (v = !1)),
                        v || ((B = S.apply(null, arguments)), g.set(arguments[k], B)),
                        i > 0 &&
                          ((E[k] = { cacheItem: g, arg: arguments[k] }),
                          v ? t(I, E) : I.push(E),
                          I.length > i && n(I.shift())),
                        (m.wasMemoized = v),
                        (m.numArgs = k + 1),
                        B
                      );
                    };
                    return (m.limit = i), (m.wasMemoized = !1), (m.cache = f), (m.lru = I), m;
                  };
                };
                function t(i, f) {
                  var I = i.length,
                ...
                function n(i) {
                  var f = i.length,
                    ...
                    m;
                  for (
                    I.cacheItem.delete(I.arg), m = f - 2;
                    m >= 0 && ((I = i[m]), (S = I.cacheItem.get(I.arg)), !S || !S.size);
                    m--
                  )
                    I.cacheItem.delete(I.arg);
                }
                function l(i, f) {
                  return i === f || (i !== i && f !== f);
                }
    ...
    var to = __STORYBOOK_API__,
      {
        ...
        eventMatchesShortcut: po,
        eventToShortcut: mo,
        experimental_MockUniversalStore: fo,
    ...
    d();
    p();
    var Ko = __STORYBOOK_CLIENT_LOGGER__,
      { deprecate: Yo, logger: U, once: Wo, pretty: Vo } = __STORYBOOK_CLIENT_LOGGER__;
    u();
    d();
    p();
    var Qo = __STORYBOOK_COMPONENTS__,
      {
        ...
        getStoryHref: it,
        icons: at,
        interleaveSeparators: st,
        nameSpaceClassNames: lt,
        resetComponents: It,
        withReset: ut,
    ...
    d();
    p();
    var ht = __STORYBOOK_ICONS__,
      {
        AccessibilityAltIcon: gt,
        AccessibilityIcon: St,
        AccessibilityIgnoredIcon: bt,
        AddIcon: Ct,
        AdminIcon: yt,
        AlertAltIcon: _t,
        AlertIcon: Tt,
        ...
        AlignRightIcon: Ot,
        AppleIcon: At,
        ArrowBottomLeftIcon: vt,
        ArrowBottomRightIcon: wt,
        ArrowDownIcon: Bt,
        ArrowLeftIcon: Et,
        ArrowRightIcon: xt,
        ArrowSolidDownIcon: Rt,
        ArrowSolidLeftIcon: Lt,
        ArrowSolidRightIcon: Pt,
        ArrowSolidUpIcon: Mt,
        ArrowTopLeftIcon: Dt,
        ArrowTopRightIcon: Gt,
        ArrowUpIcon: Ut,
        AzureDevOpsIcon: Ht,
        BackIcon: Nt,
        BasketIcon: Ft,
        ...
        ChevronLeftIcon: pr,
        ChevronRightIcon: mr,
        ChevronSmallDownIcon: fr,
        ChevronSmallLeftIcon: hr,
        ChevronSmallRightIcon: gr,
        ...
        CommitIcon: Mr,
        CompassIcon: Dr,
        ComponentDrivenIcon: Gr,
        ComponentIcon: Ur,
        ContrastIcon: Hr,
        ContrastIgnoredIcon: Nr,
        ControlsIcon: Fr,
        CopyIcon: qr,
        CreditIcon: zr,
        CrossIcon: Kr,
        ...
        PhotoDragIcon: ui,
        PhotoIcon: J,
        PhotoStabilizeIcon: di,
        PinAltIcon: pi,
        PinIcon: mi,
        PlayAllHollowIcon: fi,
        PlayBackIcon: hi,
        PlayHollowIcon: gi,
        PlayIcon: Si,
        PlayNextIcon: bi,
        PlusIcon: Ci,
        PointerDefaultIcon: yi,
        PointerHandIcon: _i,
        PowerIcon: Ti,
        PrintIcon: ki,
        ProceedIcon: Oi,
...
`)),
    ...
    var ee = "storybook/background",
      ...
      oe = (0, N.default)(1e3)((e, o, a, r, c, h) => ({
        id: e || o,
        title: o,
        onClick: () => {
          c({ selected: a, name: o });
        ...
        value: a,
        right: r ? C.createElement(Ie, { background: a }) : void 0,
        active: h,
      })),
      de = (0, N.default)(10)((e, o, a) => {
        const r = e.map(({ name: c, value: h }) => oe(null, c, h, !0, a, h === o));
        return o !== "transparent"
          ? [oe("reset", "Clear background", "transparent", null, a, !1), ...r]
          : r;
      }),
      pe = { default: null, disable: !0, values: [] },
      me = L(() => {
        const e = D(A, pe),
          [o, a] = K(!1),
          [r, c] = M(),
          h = r[A]?.value,
          s = z(() => ue(h, e.values, e.default), [e, h]);
        Array.isArray(e) &&
          U.warn(
    ...
    P.register(ee, () => {
      P.add(ee, {
        ...
        render: () =>
          C.createElement(R, null, C.createElement(me, null), C.createElement(fe, null)),
      });
    });
  })();
} catch (e) {

...
import { B as p } from "./Button-eGzUney-.js";
import { C as a, b as n, c as t, a as s, d as u, e as C } from "./Card-D3vB3BNs.js";
...
const T = {
    ...
    argTypes: {
      ...
      iconName: {
        control: "select",
        options: [void 0, "sparkles", "dice5", "book", "chevron-left", "chevron-right"],
  ...
  i = {
    args: { className: "w-[350px]", variant: "primary" },
    render: (r) =>
      e.jsxs(a, {
        ...r,
        children: [
          e.jsxs(n, {
            children: [
              e.jsx(t, { children: "Character Info" }),
              e.jsx(u, { children: "Stats and conditions" }),
            ],
          }),
          e.jsxs(s, {
            children: [
              e.jsxs("div", {
                ...
                children: [
                  e.jsx("span", { className: "font-bold", children: "Strength" }),
                  e.jsx("span", { children: "16 (+3)" }),
                ],
              }),
              e.jsxs("div", {
                className: "flex justify-between items-center py-2 border-b border-current/10",
                children: [
                  e.jsx("span", { className: "font-bold", children: "Dexterity" }),
                  e.jsx("span", { children: "14 (+2)" }),
                ],
              }),
              e.jsxs("div", {
                className: "flex justify-between items-center py-2",
                children: [
                  e.jsx("span", { className: "font-bold", children: "Constitution" }),
                  e.jsx("span", { children: "15 (+2)" }),
                ],
              }),
            ],
          }),
          e.jsxs(C, {
            ...
            children: [
              e.jsx(p, { variant: "secondary", children: "Cancel" }),
              e.jsx(p, { variant: "primary", children: "Save Changes" }),
            ],
          }),
        ],
      }),
  ...
  d = {
    render: () =>
      e.jsx("div", {
        ...
        children: ["primary", "secondary", "accent", "subtle", "rule"].map((r) =>
          e.jsxs(
            a,
            {
              variant: r,
              children: [
                e.jsx(n, {
                  children: e.jsxs(t, { className: "capitalize", children: [r, " Variant"] }),
                }),
                e.jsxs(s, {
                  children: [
                    "This card uses the ",
      ...
      e.jsxs("div", {
        ...
        children: [
          e.jsxs(a, {
            variant: "subtle",
            children: [
              e.jsx(n, { children: e.jsx(t, { children: "Default Padding" }) }),
              e.jsx(s, {
                variant: "default",
                children: e.jsx("div", {
                  className:
                    "bg-[var(--theme-primary)]/10 h-16 w-full rounded flex items-center justify-center",
                  children: "Default",
                }),
              }),
            ],
          ...
          e.jsxs(a, {
            variant: "subtle",
            children: [
              e.jsx(n, { children: e.jsx(t, { children: "Dense Padding" }) }),
              e.jsx(s, {
                variant: "dense",
                children: e.jsx("div", {
                  className:
  ...
  c = {
    render: () =>
      e.jsxs(a, {
        ...
        className: "max-w-xl",
        children: [
          e.jsx(n, { children: e.jsx(t, { children: "Critical Hits" }) }),
          e.jsxs(s, {
            variant: "rule",
            children: [
      ...
      e.jsxs("div", {
        ...
        children: [
          e.jsxs(a, {
            ...
            iconVariant: "primary",
            children: [
              e.jsx(n, { children: e.jsx(t, { children: "Generator" }) }),
              e.jsx(s, { children: "Primary themed icon (Dice)" }),
            ],
          }),
          e.jsxs(a, {
            iconName: "book",
            ...
            children: [
              e.jsx(n, { children: e.jsx(t, { children: "Ruleset" }) }),
              e.jsx(s, { children: "Secondary themed icon (Book)" }),
            ],
          }),
          e.jsxs(a, {
            iconName: "sparkles",
            iconVariant: "accent",
            children: [
              e.jsx(n, { children: e.jsx(t, { children: "New Features" }) }),
              e.jsx(s, { children: "Accent themed icon (Sparkles)" }),
            ],
          }),
        ],
      }),
      ...
      e.jsx("div", {
        ...
        children: [
          ...
          e.jsxs(
            ...
            {
              theme: r,
              iconName: h % 2 === 0 ? "dice5" : "book",
              iconVariant: h % 3 === 0 ? "primary" : h % 3 === 1 ? "secondary" : "accent",
              children: [
                e.jsxs(n, {
                  children: [e.jsx(t, { children: r }), e.jsx(u, { children: "Theme Example" })],
                }),
                e.jsx(s, {
                  children: e.jsxs("div", {
                    className: "space-y-2",
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          ...
                          e.jsx("span", { className: "font-bold", children: "80%" }),
                        ],
                      }),
                      e.jsx("div", {
                        className: "h-2 w-full bg-current/20 rounded-full overflow-hidden",
                        children: e.jsx("div", {
                          className: "h-full bg-[var(--theme-bg)]",
                          style: { width: "80%" },
                        }),
                      }),
                    ],
                ...
                e.jsx(C, {
                  className: "flex justify-end border-t border-current/10 pt-4 mt-2",
                  children: e.jsx(p, { children: "Action" }),
                }),
              ],
            },
            r,
...
d.parameters = {
  ...
  render: () => <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">\r
    ...
    description: {
      story: `All five semantic visual variants. Each matches a distinct design system pattern:\r
...
\r
    ...
    description: {
      story: "Demonstrates the different density options available for `CardContent`.",
...
const S = ["Default", "Variants", "ContentDensity", "RuleBlock", "Icons", "Themes"];
export {
  o as ContentDensity,
  i as Default,
  l as Icons,

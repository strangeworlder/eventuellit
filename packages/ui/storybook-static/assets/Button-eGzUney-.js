...
import { t as m, c as i } from "./bundle-mjs-Ce1ZTWB2.js";
  ...
  (
    ...
    d.jsx("button", {
      ...
      className: u(
        ...
        {
          "h-12 px-6 py-2": a === "default",
          "h-9 px-3": a === "sm",
          "h-14 px-8 py-4 text-xl w-full": a === "lg",
          "h-10 w-10 min-w-[2.5rem] px-0 py-0 text-xl font-black leading-none": a === "icon",
...
n.__docgenInfo = {
  ...
  props: {
    variant: {
      ...
      tsType: {
        name: "union",
        raw: '"primary" | "secondary" | "danger" | "ghost" | "ghost-secondary"',
        elements: [
          { name: "literal", value: '"primary"' },
          { name: "literal", value: '"secondary"' },
          { name: "literal", value: '"danger"' },
          { name: "literal", value: '"ghost"' },
          { name: "literal", value: '"ghost-secondary"' },
        ],
      },
      description: "",
    ...
    size: {
      ...
      tsType: {
        name: "union",
        raw: '"default" | "sm" | "lg" | "icon" | "nav"',
        elements: [
          { name: "literal", value: '"default"' },
          { name: "literal", value: '"sm"' },
          { name: "literal", value: '"lg"' },
          { name: "literal", value: '"icon"' },
          { name: "literal", value: '"nav"' },
        ],
      },
      description: "",

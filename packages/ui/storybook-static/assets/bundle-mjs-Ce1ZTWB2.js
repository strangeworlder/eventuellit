...
const Ne = (e, t) => {
  ...
  Ee = (e, t) => ({ classGroupId: e, validator: t }),
  ...
  qe = (e) => "isThemeGetter" in e && e.isThemeGetter === !0,
  Xe = (e) => {
  ...
  Qe = (e) => ({ cache: Xe(e.cacheSize), parseClassName: He(e), sortModifiers: Ke(e), ...Fe(e) }),
  Ze = /\s+/,
  eo = (e, t) => {
    const {
        parseClassName: r,
  ...
  Co = () => {
    const e = f("color"),
      ...
      c = () => [e, n, s],
      de = () => [...E(), ke, xe, { position: [n, s] }],
      me = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      pe = () => ["auto", "cover", "contain", ko, fo, { size: [n, s] }],
      oe = () => [te, B, L],
      w = () => ["", "none", "full", u, n, s],
      x = () => ["", p, B, L],
    ...
    return {
      ...
      classGroups: {
        ...
        w: [{ w: [b, "screen", ...j()] }],
        "min-w": [{ "min-w": [b, "screen", "none", ...j()] }],
        "max-w": [{ "max-w": [b, "screen", "none", "prose", { screen: [a] }, ...j()] }],
        h: [{ h: ["screen", "lh", ...j()] }],
        "min-h": [{ "min-h": ["screen", "lh", "none", ...j()] }],
        "max-h": [{ "max-h": ["screen", "lh", ...j()] }],
        "font-size": [{ text: ["base", r, B, L] }],
        "font-smoothing": ["antialiased", "subpixel-antialiased"],
        "font-style": ["italic", "not-italic"],
        "font-weight": [{ font: [o, vo, go] }],
        "font-stretch": [
          {
            "font-stretch": [
              "ultra-condensed",
        ...
        "text-decoration-thickness": [{ decoration: [p, "from-font", "auto", n, L] }],

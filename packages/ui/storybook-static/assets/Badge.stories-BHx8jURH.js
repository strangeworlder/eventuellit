...
import { B as a } from "./Badge-BvuDV21L.js";
...
const v = {
  ...
  n = { args: { variant: "primary", children: "Tervetuloa seikkailuun", icon: "sparkles" } },
  s = { args: { variant: "secondary", children: "Sääntökirja", icon: "book" } },
  t = { args: { variant: "accent", children: "Hahmopaja", icon: "dice5" } },
  i = { args: { variant: "outline", children: "Päivitys saatavilla" } },
  c = { args: { variant: "accent-solid", children: "Aktiivinen" } },
  o = {
    render: (r) =>
      e.jsxs("div", {
        ...
        children: [
          e.jsxs("div", {
            ...
            "data-theme": "base",
            children: [
              e.jsx(a, { ...r, theme: "base", children: "Perusteema" }),
              e.jsx(a, { ...r, theme: "inverted", children: "Käänteinen teema" }),
            ],
          }),
          e.jsxs("div", {
            className: "flex gap-2",
            ...
            children: [
              e.jsx(a, { ...r, theme: "primary-dark", children: "Tumma pääteema" }),
              e.jsx(a, { ...r, theme: "secondary-dark", children: "Tumma sivuteema" }),
            ],
          }),
        ],
      }),
    args: { variant: "primary", icon: "sparkles" },
  };
n.parameters = {
  ...n.parameters,
  docs: {
...
const y = ["Primary", "Secondary", "Accent", "Outline", "AccentSolid", "WithDifferentThemes"];
export {
  t as Accent,
  c as AccentSolid,
  i as Outline,

...
import { c as p, B as l } from "./Button-eGzUney-.js";
import { G as r } from "./GameTerm-B5TXl4CZ.js";
import { R as x } from "./iframe-RLsCwdXb.js";
import { H as h, a as f } from "./Heading-DaMVR3YC.js";
import "./bundle-mjs-Ce1ZTWB2.js";
import "./preload-helper-PPVm8Dsz.js";
const n = x.forwardRef(
  ({ className: c, variant: s = "info", title: o, actions: i, children: m, ...d }, u) =>
    e.jsxs("div", {
      ref: u,
      className: p(
        "rounded-sm p-6 text-[var(--theme-text)]",
        {
          "border-2 border-[var(--theme-secondary)]/50 bg-[var(--theme-secondary)]/5 shadow-[0_0_15px_color-mix(in_srgb,var(--theme-secondary)_20%,transparent)]":
            s === "success",
          "border-l-4 border-[var(--theme-accent)] bg-[var(--theme-accent)]/10": s === "info",
        },
        c,
      ),
      ...d,
      children: [
        e.jsxs(h, {
          children: [
            o ? e.jsx(f, { className: "mb-3", children: o }) : null,
            e.jsx("div", { className: "text-[var(--theme-text)]/85", children: m }),
          ],
        }),
        i ? e.jsx("div", { className: "mt-6 flex gap-4", children: i }) : null,
      ],
    }),
);
n.displayName = "NoticePanel";
n.__docgenInfo = {
  description: "Semantic callout panel for success and informational notices.",
  methods: [],
...
const k = {
  ...
  a = {
    args: {
      ...
      actions: e.jsxs(e.Fragment, {
        children: [
          e.jsx(l, { children: "Palaa listaan" }),
          e.jsx(l, { variant: "secondary", children: "Tee uusi hahmo" }),
        ],
      }),
    },
  },
  t = {
    render: () =>
      e.jsx(n, {
        variant: "info",
        title: "Nopat ja toiminta",
        children: e.jsxs("p", {
          className: "text-lg leading-relaxed",
          children: [
            "Sinulla on ",
            e.jsx(r, { variant: "accent", className: "font-black text-xl", children: "5n20" }),
            " ",
            "oletuksena. Olet ottanut",
            " ",
            e.jsx(r, { variant: "primary", className: "font-bold", children: "2 vauriota" }),
            ", joten noppapoolisi koko on",
            " ",
            e.jsx(r, { variant: "primary", className: "font-black text-2xl", children: "3" }),
            ".",
          ],
        }),
      }),
...
const _ = ["Onnistuminen", "Tieto"];
export { a as Onnistuminen, t as Tieto, _ as __namedExportsOrder, k as default };

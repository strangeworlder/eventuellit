...
const h = { title: "Suunnittelujarjestelma/Perustat/Tokens", parameters: { layout: "padded" } },
  a = { mobile: "640px", tablet: "768px", desktop: "1024px", "x-wide": "1280px" },
  c = {
    0: "0px",
    px: "1px",
    0.5: "0.125rem (2px)",
  ...
  t = {
    render: () =>
      e.jsxs("div", {
        className: "space-y-8 flex flex-col font-sans",
        children: [
          e.jsxs("div", {
            children: [
              e.jsx("h2", {
              ...
              e.jsxs("p", {
                className: "opacity-80 mb-6 max-w-prose",
                children: [
                  "These are the standard breakpoints defined in our Design System. Use them as prefixes in your Tailwind classes to apply responsive styles (e.g.,",
                  " ",
                  e.jsx("code", {
                    className: "bg-white/10 px-1 py-0.5 rounded",
                    children: "tablet:text-lg",
                  }),
                  ",",
                  " ",
                  e.jsx("code", {
                    className: "bg-white/10 px-1 py-0.5 rounded",
                    children: "desktop:flex-row",
                  }),
                  ").",
                ],
              }),
              e.jsx("div", {
                className: "border border-white/10 rounded-lg overflow-hidden bg-background",
                  ...
                  children: [
                    e.jsx("thead", {
                      children: e.jsxs("tr", {
                        ...
                        children: [
                          e.jsx("th", { className: "py-3 px-4 font-semibold", children: "Prefix" }),
                          e.jsx("th", {
                    ...
                    e.jsx("tbody", {
                      children: Object.entries(a).map(([s, r]) =>
                        e.jsxs(
                          "tr",
                          {
                            ...
                            children: [
                              e.jsx("td", {
                                ...
                                children: e.jsxs("code", {
                                  className:
                                    "text-accent-300 font-bold bg-accent-900/50 px-2 py-1 rounded",
                                  children: [s, ":"],
                                }),
                              }),
                              e.jsx("td", { className: "py-3 px-4 text-primary-200", children: r }),
                              e.jsx("td", {
                                className: "py-3 px-4",
                                children: e.jsxs("code", {
                                  className: "opacity-70 text-sm",
                                  children: ["--breakpoint-", s],
                                }),
                              }),
                            ],
                          },
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsx("p", {
                className: "opacity-80 mb-6 text-sm",
                children:
                  "Resize your browser window to see how the container responds to these breakpoints.",
              }),
              e.jsxs("div", {
                className:
                  "relative h-32 rounded-lg border-2 border-dashed border-white/20 bg-white/5 flex items-center justify-center p-4 text-center transition-all duration-300",
                children: [
                  e.jsxs("div", {
                    className:
                      "absolute inset-0 flex items-center justify-center font-bold text-lg pointer-events-none",
                    children: [
                      e.jsxs("span", {
                        className: "block mobile:hidden text-white/50",
                        children: ["Base (< ", a.mobile, ")"],
                      }),
                      e.jsxs("span", {
                        className: "hidden mobile:block tablet:hidden text-accent-300",
                        children: ["Mobile (≥ ", a.mobile, ")"],
                      }),
                      e.jsxs("span", {
                        className: "hidden tablet:block desktop:hidden text-secondary-300",
                        children: ["Tablet (≥ ", a.tablet, ")"],
                      }),
                      e.jsxs("span", {
                        className: "hidden desktop:block x-wide:hidden text-primary-300",
                        children: ["Desktop (≥ ", a.desktop, ")"],
                      }),
                      e.jsxs("span", {
                        className: "hidden x-wide:block text-green-300",
                        children: ["X-Wide (≥ ", a["x-wide"], ")"],
                      }),
                    ],
                  }),
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("div", {
                        className:
                          "h-2 w-8 rounded-full bg-white/20 mobile:bg-white/50 transition-colors",
                        title: "Mobile",
                      }),
                      e.jsx("div", {
                        className:
                          "h-2 w-8 rounded-full bg-white/20 tablet:bg-secondary-500 transition-colors",
                        title: "Tablet",
                      }),
                      e.jsx("div", {
                        className:
                          "h-2 w-8 rounded-full bg-white/20 desktop:bg-primary-500 transition-colors",
                        title: "Desktop",
                      }),
                      e.jsx("div", {
                        className:
                          "h-2 w-8 rounded-full bg-white/20 x-wide:bg-green-500 transition-colors",
                        title: "X-Wide",
                      }),
                    ],
                  }),
        ...
        children: e.jsxs("div", {
          children: [
            ...
            e.jsxs("p", {
              className: "opacity-80 mb-6 max-w-prose",
              children: [
                "The spacing scale is used for margins, paddings, gaps, and positioning. It follows a predictable progression. Use Tailwind classes like ",
                e.jsx("code", { children: "p-4" }),
                ", ",
                e.jsx("code", { children: "m-2" }),
                ",",
                " ",
                e.jsx("code", { children: "gap-8" }),
                ".",
              ],
            }),
            e.jsx("div", {
              className: "flex flex-col gap-2",
              children: Object.entries(c).map(([s, r]) => {
                const l = r.match(/(\d+)px/),
                  o = l ? parseInt(l[1], 10) : s === "0" ? 0 : 1;
                return e.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      e.jsx("div", {
                        className:
                          "w-16 font-mono text-right opacity-70 border-r border-white/10 pr-4",
                        children: s,
                      }),
                      e.jsx("div", { className: "w-32 opacity-90", children: r }),
                      e.jsx("div", {
                        className: "flex-1",
                        children: e.jsx("div", {
                          className: "h-4 bg-primary-500 rounded-sm",
                          style: { width: `${o}px`, minWidth: o > 0 ? "1px" : "0" },
                        }),
                      }),
                    ],
                  },
          ...
          children: [
            ...
            e.jsxs("p", {
              ...
              children: [
                ...
                e.jsx("code", { children: "rounded-md" }),
                ",",
                " ",
                e.jsx("code", { children: "rounded-full" }),
                ".",
              ],
            }),
            e.jsx("div", {
              className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6",
              children: Object.entries(m).map(([s, r]) =>
                e.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      e.jsxs("div", {
                        className:
                          "h-24 bg-white/10 border border-white/20 flex items-center justify-center",
                        style: { borderRadius: r },
                        children: [
                          e.jsx("div", {
                            className: "w-4 h-4 rounded-full bg-white/20 absolute top-2 left-2",
                          }),
                          e.jsx("div", {
                            className: "w-4 h-4 rounded-full bg-white/20 absolute top-2 right-2",
                          }),
                          e.jsx("div", {
                            className: "w-4 h-4 rounded-full bg-white/20 absolute bottom-2 left-2",
                          }),
                          e.jsx("div", {
                            className: "w-4 h-4 rounded-full bg-white/20 absolute bottom-2 right-2",
                          }),
                        ],
                      }),
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsx("span", {
                            ...
                            children: s === "DEFAULT" ? "rounded" : `rounded-${s}`,
                          }),
                          e.jsx("div", { className: "opacity-70", children: r }),
                        ],
                      }),
                    ],
                  },
      ...
      e.jsx("div", {
        ...
        children: e.jsxs("div", {
          children: [
            e.jsx("h2", {
              className: "text-2xl font-heading font-bold mb-4",
              children: "Layout Tokens",
            }),
            e.jsx("p", {
              className: "opacity-80 mb-8 max-w-prose",
              children:
                "These tokens represent standard page structures in our application. They are implemented as utility classes rather than components to remain flexible.",
            }),
            e.jsx("div", {
              className: "space-y-10",
              children: Object.entries(p).map(([s, r]) =>
                e.jsxs(
                  "div",
                  {
                    className: "space-y-4",
                    children: [
                      e.jsxs("div", {
                        ...
                        children: [
                          e.jsxs("code", {
                            className:
                              "text-accent-300 font-bold bg-accent-900/50 px-2 py-1 rounded text-lg",
                            children: [".", r.name],
                          }),
                          e.jsx("span", {
                        ...
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("div", {
                                className:
                                  "flex justify-between text-xs opacity-50 uppercase tracking-widest",
                                children: e.jsx("span", { children: "Structure" }),
                              }),
                              e.jsx("p", { className: "font-mono text-sm", children: r.structure }),
                              e.jsx("div", {
                                className:
                                  "pt-4 flex justify-between text-xs opacity-50 uppercase tracking-widest",
                                children: e.jsx("span", { children: "Common Usage" }),
                              }),
                              e.jsx("p", { className: "text-sm", children: r.usage }),
                            ],
                          }),
                          e.jsxs("div", {
                            className:
                              "relative border border-dashed border-white/20 rounded-lg bg-white/5 min-h-[200px] overflow-hidden p-2",
                            children: [
                              e.jsx("div", {
                                className:
                                  "absolute top-2 right-2 text-[10px] opacity-30 font-mono",
                                children: "Visual Preview",
                              }),
                              s === "stack"
                                ? e.jsxs("div", {
                                    className: "layout-stack py-4 h-full",
                                    children: [
                                      e.jsx("div", {
                                        className:
                                          "h-8 bg-primary-500/20 rounded border border-primary-500/30 w-full flex items-center justify-center text-xs",
                                        children: "Section 1",
                                      }),
                                      e.jsx("div", {
                                        className:
                                          "h-24 bg-primary-500/20 rounded border border-primary-500/30 w-full flex items-center justify-center text-xs",
                                        children: "Main Content",
                                      }),
                                      e.jsx("div", {
                                        className:
                                          "h-12 bg-primary-500/20 rounded border border-primary-500/30 w-full flex items-center justify-center text-xs",
                                        children: "Section 2",
                                      }),
                                    ],
                                  })
                                : e.jsxs("div", {
                                    className: "layout-split py-4 h-full",
                                    children: [
                                      e.jsx("div", {
                                        className:
                                          "h-32 bg-secondary-500/20 rounded border border-secondary-500/30 flex items-center justify-center text-xs",
                                        children: "Main Column",
                                      }),
                                      e.jsx("div", {
                                        className:
                                          "h-32 bg-accent-500/20 rounded border border-accent-500/30 flex items-center justify-center text-xs",
                                        children: "Sidebar",
                                      }),
                                    ],
                                  }),
...
const b = ["Breakpoints", "Spacing", "BorderRadius", "Layout"];
export {
  n as BorderRadius,
  t as Breakpoints,
  d as Layout,

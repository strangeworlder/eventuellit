...
import { i as r, I as a } from "./Icon-dO9IW84r.js";
import { D as o } from "./DiceIcon-BoLGTUrC.js";
...
const h = {
    ...
    parameters: {
      ...
      docs: {
        description: {
          component: `The icon system provides a consistent visual language for actions, navigation, and game concepts.\r
          ...
          e.jsxs("div", {
            ...
            children: [
              ...
              e.jsx("p", {
                ...
                children:
                  "Our icon set is based on Lucide React and follows a clean, geometric aesthetic. Use icons to provide visual cues and enhance the user interface.",
              }),
            ],
          }),
          e.jsxs("div", {
            className: "p-8 md:p-16 flex flex-col gap-20",
            children: [
              e.jsxs("section", {
                children: [
                  e.jsxs("div", {
                    className: "flex flex-col gap-2 mb-8 border-b border-white/5 pb-4",
                    children: [
                      e.jsx("h2", {
                        className: "text-3xl font-heading font-black",
                        children: "General UI Icons",
                      }),
                      e.jsx("p", {
                        className: "opacity-60",
                        children: "Standard functional icons for navigation and control.",
                      }),
                    ],
                  }),
                  e.jsx("div", {
                    ...
                    children: Object.keys(r).map((n) =>
                      e.jsxs(
                        ...
                        {
                          className:
                            "flex flex-col p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-accent-500/50 hover:bg-white/10 transition-all group",
                          children: [
                            e.jsxs("div", {
                              ...
                              children: [
                                e.jsx("div", {
                                  className:
                                    "p-4 rounded-xl bg-accent-500/10 text-accent-400 group-hover:scale-110 transition-transform",
                                  children: e.jsx(a, { name: n, size: 32 }),
                                }),
                                e.jsx("code", {
                                  className:
                                    "text-xs opacity-50 font-mono bg-black/30 px-2 py-1 rounded",
                                  children: n,
                                }),
                              ],
                            }),
                            e.jsx("h3", {
                              className: "text-lg font-heading font-bold mb-2 capitalize",
                              children: n.replace("-", " "),
                            }),
                            e.jsx("p", {
                              className: "text-sm opacity-70 leading-snug min-h-[3rem]",
                              children: c[n] || "No description available.",
                            }),
                            e.jsx("div", {
                              className: "mt-6 pt-4 border-t border-white/5 flex gap-3",
                              children: e.jsxs("div", {
                                ...
                                children: [
                                  ...
                                  e.jsx("code", {
                                    className: "text-[11px] bg-black/20 px-2 py-1 rounded",
                                    children: `<Icon name="${n}" />`,
                                  }),
                                ],
                              }),
                            }),
                ...
                children: [
                  e.jsxs("div", {
                    ...
                    children: [
                      e.jsx("h2", {
                        className: "text-3xl font-heading font-black",
                        children: "Specialized Icons",
                      }),
                      e.jsx("p", {
                        className: "opacity-60",
                        children: "Domain-specific components for game mechanics.",
                      }),
                    ],
                  }),
                  e.jsx("div", {
                    className:
                      "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6",
                    children: [4, 6, 8, 10, 12, 20].map((n) =>
                      e.jsxs(
                        "div",
                        {
                          className:
                            "flex flex-col p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-secondary-500/50 hover:bg-white/10 transition-all group",
                          children: [
                            e.jsxs("div", {
                              className: "flex items-center justify-between mb-4",
                              children: [
                                e.jsx("div", {
                                  className:
                                    "p-2 rounded-xl bg-secondary-500/10 text-secondary-400 group-hover:scale-110 transition-transform",
                                  children: e.jsx(o, { faces: n, size: "lg" }),
                                }),
                                e.jsxs("code", {
                                  className:
                                    "text-xs opacity-50 font-mono bg-black/30 px-2 py-1 rounded",
                            ...
                            e.jsxs("p", {
                              ...
                              children: [
                                ...
                                n,
                                "-sided die. Used in dice pools and roll results.",
                              ],
                            }),
                            e.jsx("div", {
                              className: "mt-6 pt-4 border-t border-white/5 flex gap-3",
              ...
              e.jsxs("section", {
                className:
                  "p-8 rounded-3xl bg-gradient-to-br from-primary-900/40 to-secondary-900/40 border border-white/10",
                children: [
                  e.jsx("h2", {
                  ...
                  e.jsxs("p", {
                    ...
                    children: [
                      "To add a new icon to the design system, import it from ",
                      e.jsx("code", { className: "text-accent-300", children: "lucide-react" }),
                      " in",
                      e.jsx("code", { className: "text-accent-300", children: " Icon.tsx" }),
                      " and add it to the ",
                      e.jsx("code", { className: "text-accent-300", children: "icons" }),
                      " object.",
                    ],
                  }),
                  e.jsx("div", {
                    className: "bg-black/40 p-4 rounded-lg font-mono text-sm overflow-x-auto",
                    children: e.jsx("pre", {
                      className: "text-blue-300",
                      children: `// packages/ui/src/components/Icon.tsx
export const icons = {
  // ... existing icons
...
export const icons = {
  ...
  "new-icon": NewLucideIcon,
    ...
    description: {
      story: "The complete gallery of available icons in the system.",
      ...s.parameters?.docs?.description,
    },
  },
};
const b = ["Gallery"];
export { s as Gallery, b as __namedExportsOrder, h as default };

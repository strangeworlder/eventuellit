import { j as c } from "./jsx-runtime-u17CrQMm.js";
import { S as l } from "./StatBlock-DepS-IkV.js";
...
const k = {
  ...
  a = { args: { label: "Terveys", value: 10, maxValue: 20, icon: "zap" } },
  e = { args: { label: "Krediitit", value: 15420, icon: "sparkles" } },
  r = { args: { label: "Taso", value: 5, icon: "dice5" } },
  s = {
    args: { label: "Kokemus", value: 750, maxValue: 1e3, variant: "accent", icon: "sparkles" },
  },
  n = { args: { label: "Sisu", value: 3, maxValue: 6, variant: "primary", icon: "shield" } },
  o = {
    args: { label: "Teema", value: 0 },
    render: () => {
      const i = [
        "base",
        "inverted",
      ...
      return c.jsx("div", {
        className:
          "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 min-w-[300px] sm:min-w-[600px] lg:min-w-[1000px]",
        children: i.map((t) =>
          c.jsx(
            l,
            {
...
const S = ["Default", "LargeNumbers", "WithoutMax", "Accent", "Primary", "ThemeShowcase"];
export {
  s as Accent,
  a as Default,
  e as LargeNumbers,

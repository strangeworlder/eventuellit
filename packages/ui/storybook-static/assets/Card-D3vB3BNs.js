import { j as n } from "./jsx-runtime-u17CrQMm.js";
import { R as l } from "./iframe-RLsCwdXb.js";
import { c as i } from "./Button-eGzUney-.js";
import { H as C, a as T } from "./Heading-DaMVR3YC.js";
import { I as w } from "./Icon-dO9IW84r.js";
import { u as _, T as N, p as j } from "./Theme-9Lj_OJ7_.js";
  ...
  u = l.forwardRef(
    (
      ...
      return n.jsx(N.Provider, {
        value: k,
        children: n.jsx(p.Provider, {
          value: { iconName: r, iconVariant: d },
          children: n.jsx("div", {
            ref: f,
            "data-theme": m,
            "data-variant": e,
            className: i(
              "rounded-xl overflow-visible relative group",
              {
                ...
                "bg-[var(--theme-secondary)]/10 text-[var(--theme-text)] border-l-8 border-l-[var(--theme-primary)] border-t-0 border-r-0 border-b-0 shadow-[inset_0_0_20px_color-mix(in_srgb,var(--theme-secondary)_10%,transparent)] hover:shadow-[inset_0_0_30px_color-mix(in_srgb,var(--theme-secondary)_15%,transparent)] transition-shadow":
                  e === "rule",
                "[corner-shape:scoop_round_round_round] rounded-tl-4xl": r,
              },
              t,
            ),
            ...o,
            children: n.jsx(C, { children: s }),
          }),
        }),
      });
    },
...
u.displayName = "Card";
const h = l.forwardRef(({ className: t, theme: e, children: a, ...r }, d) => {
  const { iconName: s, iconVariant: o } = q();
  return n.jsxs("div", {
    ref: d,
    "data-theme": e,
    className: i("flex flex-col space-y-1.5 p-4 tablet:p-6 border-b-2 border-current/20", t),
    ...r,
    children: [
      s &&
        n.jsx("div", {
          className: i(
            ...
            {
              "border-[var(--theme-bg)] border-2 text-[var(--theme-bg)]": o === "primary",
              "border-[var(--theme-primary)]/50 border-2 text-[var(--theme-primary)]/50":
                o === "secondary",
              "border-[var(--theme-accent)]/50 border-2 text-[var(--theme-accent)]/50":
                o === "accent",
            },
          ),
          children: n.jsx(w, { name: s, size: 28 }),
        }),
      a,
    ],
  });
...
const v = l.forwardRef(({ className: t, theme: e, ...a }, r) =>
  n.jsx(T, { ref: r, "data-theme": e, className: i("font-bold", t), ...a }),
);
v.displayName = "CardTitle";
const y = l.forwardRef(({ className: t, theme: e, ...a }, r) =>
  n.jsx("p", {
    ref: r,
    "data-theme": e,
    className: i("text-lg font-bold uppercase tracking-wider opacity-80", t),
    ...a,
  }),
);
y.displayName = "CardDescription";
const b = l.forwardRef(({ className: t, variant: e = "default", theme: a, ...r }, d) =>
  n.jsx("div", {
    ref: d,
    "data-theme": a,
    className: i(
      "flex flex-col",
      {
        "gap-6 p-4 pt-4 tablet:p-6 tablet:pt-6": e === "default",
        "gap-4 p-3 tablet:p-4": e === "dense",
        "gap-4 p-4 tablet:p-6 text-[var(--theme-text)]/90 leading-relaxed font-light": e === "rule",
      },
      t,
    ),
    ...r,
...
const g = l.forwardRef(({ className: t, theme: e, ...a }, r) =>
  n.jsx("div", {
    ref: r,
    "data-theme": e,
    className: i("flex items-center p-4 pt-0 tablet:p-6 tablet:pt-0", t),
    ...a,
  }),
);
g.displayName = "CardFooter";
u.__docgenInfo = {
  description: `The core container block for the Card subcomponent architecture.\r
...
automatically from the CSS theme system.`,
  ...
  props: {
    variant: {
      ...
      tsType: {
        name: "union",
        raw: '"primary" | "secondary" | "accent" | "subtle" | "rule"',
        elements: [
          { name: "literal", value: '"primary"' },
          { name: "literal", value: '"secondary"' },
          { name: "literal", value: '"accent"' },
          { name: "literal", value: '"subtle"' },
          { name: "literal", value: '"rule"' },
        ],
      },
      description:
...
| "accent-dark"`,
    ...
    iconVariant: {
      ...
      description: 'The color variant for the icon container. Defaults to "primary".',
      defaultValue: { value: '"primary"', computed: !1 },
    },
  },
};
...
b.__docgenInfo = {
  ...
  props: {
    variant: {
      ...
      tsType: {
        name: "union",
        raw: '"default" | "dense" | "rule"',
        elements: [
          { name: "literal", value: '"default"' },
          { name: "literal", value: '"dense"' },
          { name: "literal", value: '"rule"' },
        ],
      },
      description: "",
...
g.__docgenInfo = {
  description: "The bottom area of the Card, normally used for rendering action buttons.",
  methods: [],
...
export { u as C, b as a, h as b, v as c, y as d, g as e };

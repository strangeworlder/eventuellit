...
import { C as s, b as n, c as d, a as i } from "./Card-D3vB3BNs.js";
import { T as m, p as l } from "./Theme-9Lj_OJ7_.js";
...
const o = [
  ...
  b = { title: "Suunnittelujarjestelma/Perustat/Teema", parameters: { layout: "padded" } },
  a = {
    render: () =>
      r.jsx("div", {
          ...
          r.jsx(
            m.Provider,
            {
              ...
              children: r.jsxs(s, {
                ...
                variant: "subtle",
                children: [
                  r.jsx(n, { children: r.jsx(d, { children: e }) }),
                  r.jsx(i, {
                    children: r.jsxs("p", {
                      className: "text-sm",
                      children: [
                        "Tama kortti nayttaa, milta sisalto nayttaa teemakontekstissa",
                        r.jsxs("span", { className: "font-bold", children: [" ", e] }),
                        ".",
                      ],
                    }),
                  }),
      ...
      r.jsx("div", {
        ...
        children: o.map((e) =>
          r.jsxs(
            "div",
            {
              className: "rounded-lg border border-[var(--theme-primary)]/20 p-4",
              children: [
                r.jsxs("p", {
                  className: "text-sm mb-3",
                  children: [
                    "Vanhemman teema: ",
                    r.jsx("span", { className: "font-bold", children: e }),
                  ],
                }),
                r.jsx(m.Provider, {
                  value: e,
                  children: r.jsxs(s, {
                    variant: "primary",
                    children: [
                      r.jsx(n, { children: r.jsx(d, { children: "Primary-vaihto" }) }),
                      r.jsx(i, {
                        children: r.jsxs("p", {
                          className: "text-sm",
                          children: [
                            ...
                            " ",
                            r.jsx("span", { className: "font-bold", children: l[e] }),
                          ],
                        }),
                      }),
                    ],
...
const T = ["Teemakartta", "PrimaryVaihto"];
export { t as PrimaryVaihto, a as Teemakartta, T as __namedExportsOrder, b as default };

...
import { C as j, b as k, c as w, a as N } from "./Card-D3vB3BNs.js";
import { R as S, r as n } from "./iframe-RLsCwdXb.js";
import { c as _ } from "./Button-eGzUney-.js";
import { N as B } from "./chunk-LFPYN7LY-BucxxY9a.js";
...
function K() {
  const a = n.useContext(I);
  if (!a) throw new Error("Tabs components must be used within a Tabs provider");
  return a;
}
const x = S.forwardRef(({ value: a, defaultValue: t, onValueChange: l, className: u, ...r }, o) => {
  const [p, d] = n.useState(t),
    v = a !== void 0,
    T = v ? a : p,
    R = n.useCallback(
      (g) => {
  ...
  return e.jsx(I.Provider, {
    value: { value: T, onValueChange: R },
    children: e.jsx("div", { ref: o, className: _("flex flex-col", u), ...r }),
  });
});
x.displayName = "Tabs";
const A = S.forwardRef(({ className: a, onKeyDown: t, style: l, ...u }, r) => {
  const o = n.useRef(null),
    ...
    D = n.useCallback(
      (c) => {
        (o.current = c), typeof r == "function" ? r(c) : r && (r.current = c);
      },
      [r],
    ),
    E = (c) => {
      if (!o.current || c.target.getAttribute?.("role") !== "tab") return;
      const h = Array.from(o.current.querySelectorAll('[role="tab"]:not([disabled])'));
      if (!h.length) return;
      const f = h.findIndex((C) => C === document.activeElement);
      let m = f,
        b = !1;
      switch (c.key) {
        case "ArrowRight":
      ...
      b && (c.preventDefault(), h[m]?.focus()), t?.(c);
    },
    O = n.useCallback((c) => {
      const y = c.target.closest('[role="tab"]');
      if (!y || !o.current) return;
      if (y.getAttribute("aria-selected") === "true" || y.getAttribute("aria-current") === "page") {
        d(0), T(1), g(0);
        return;
      }
      const f = Array.from(o.current.querySelectorAll('[role="tab"]')),
        m = f.findIndex(
          (H) =>
            H.getAttribute("aria-selected") === "true" || H.getAttribute("aria-current") === "page",
        ),
        b = f.indexOf(y);
      if (m === -1 || b === -1) return;
      const C = Math.abs(b - m),
        q = b > m ? 1 : -1;
      d(q * (2 + C * 2)), T(1 + C * 0.025), g(q * C);
    }, []),
    U = n.useCallback(() => {
      d(0), T(1), g(0);
    }, []);
  return e.jsx("div", {
    ...
    style: { "--tab-tug": `${p}px`, "--tab-stretch": v, "--tab-skew": `${R}deg`, ...l },
    onKeyDown: E,
    onMouseOver: O,
    onMouseLeave: U,
    ...u,
...
const s = S.forwardRef(({ className: a, value: t, theme: l, onClick: u, ...r }, o) => {
  const p = K(),
    d = p.value === t;
  return e.jsx("button", {
    ref: o,
...
s.displayName = "TabsTrigger";
const M = S.forwardRef(({ className: a, theme: t, ...l }, u) =>
  e.jsx(B, {
    ref: u,
    role: "tab",
    "data-theme": t,
...
M.displayName = "TabsLink";
const i = S.forwardRef(({ className: a, value: t, ...l }, u) =>
  K().value === t
    ? e.jsx("div", {
        ref: u,
        role: "tabpanel",
...
i.displayName = "TabsContent";
x.__docgenInfo = {
  description: `A set of layered sections of content—known as tab panels—that display one panel of content at a time.\r
...
A.__docgenInfo = { description: "", methods: [], displayName: "TabsList" };
s.__docgenInfo = {
  description: "",
  methods: [],
...
const ee = {
  ...
  L = {
    render: () =>
      e.jsx("div", {
        className: "w-full max-w-2xl bg-[var(--theme-bg)] text-[var(--theme-text)] p-8",
        children: e.jsxs(x, {
          defaultValue: "visuals",
          children: [
            e.jsxs(A, {
              children: [
                e.jsx(s, { value: "stats", children: "Ominaisuudet" }),
                e.jsx(s, { value: "skills", children: "Taidot" }),
                e.jsx(s, { value: "visuals", children: "Ulkoasu" }),
                e.jsx(s, { value: "equipment", disabled: !0, children: "Varusteet" }),
              ],
            }),
            e.jsx(i, {
              value: "stats",
              children: e.jsxs(j, {
                children: [
                  e.jsx(k, { children: e.jsx(w, { children: "Hahmon ominaisuudet" }) }),
                  e.jsx(N, {
                    children: e.jsx("p", {
                      children: "Määritä hahmon fyysiset ja henkiset ominaisuudet täällä.",
                    }),
                  }),
                ],
              }),
            ...
            e.jsx(i, {
              ...
              children: e.jsxs(j, {
                children: [
                  e.jsx(k, { children: e.jsx(w, { children: "Taidot ja kyvyt" }) }),
                  e.jsx(N, {
                    children: e.jsx("p", {
                      children: "Jaa taitopisteet ja valitse hahmon osaamiset.",
                    }),
                  }),
                ],
              }),
            ...
            e.jsx(i, {
              ...
              children: e.jsxs(j, {
                variant: "subtle",
                children: [
                  e.jsx(k, { children: e.jsx(w, { children: "Ulkoasun tiedot" }) }),
                  e.jsxs(N, {
                    children: [
                      e.jsx("p", {
                        className: "mb-4",
                        children:
                          "Tässä voit määrittää, miltä hahmosi näyttää. Välilehti yhdistyy visuaalisesti sisältöalueeseen klassisen mapin tyyliin.",
                      }),
                      e.jsx("div", {
                        className:
                          "h-24 w-24 bg-[var(--theme-secondary)]/20 border-2 border-[var(--theme-secondary)] rounded-full flex items-center justify-center",
                        children: e.jsx("span", {
                          className:
                            "text-sm font-bold uppercase tracking-widest text-[var(--theme-secondary)]",
                          children: "Muotokuva",
                        }),
                      }),
                    ],
            ...
            e.jsx(i, {
              ...
              children: e.jsx("p", {
                children:
                  "Tämän sisällön ei pidä olla käytettävissä, koska välilehti on poistettu käytöstä.",
              }),
            }),
          ],
        }),
  ...
  V = {
    render: () =>
      e.jsxs("div", {
        className: "w-full max-w-4xl grid gap-8 bg-background p-8",
        children: [
          e.jsxs(j, {
            "data-theme": "inverted",
            className: "p-8 rounded-lg shadow-lg",
            children: [
              e.jsx(k, { children: e.jsx(w, { children: "Käänteinen teema" }) }),
              e.jsx(N, {
                children: e.jsxs(x, {
                  defaultValue: "tab1",
                  children: [
                    e.jsxs(A, {
                      children: [
                        e.jsx(s, { value: "tab1", children: "Käänteinen välilehti 1" }),
                        e.jsx(s, { value: "tab2", children: "Käänteinen välilehti 2" }),
                        e.jsx(s, { value: "tab3", children: "Käänteinen välilehti 3" }),
                      ],
                    }),
                    e.jsx(i, {
                      value: "tab1",
                      children: e.jsx("div", {
                        className:
                          "p-6 bg-[var(--theme-primary)]/10 rounded-b-lg border-2 border-t-0 border-[var(--theme-primary)]",
                        children: "Sisältö käänteisen teeman välilehdelle 1.",
                      }),
                    }),
                    e.jsx(i, {
                      value: "tab2",
                      children: e.jsx("div", {
                        className:
                          "p-6 bg-[var(--theme-primary)]/10 rounded-b-lg border-2 border-t-0 border-[var(--theme-primary)]",
                        children: "Sisältö käänteisen teeman välilehdelle 2.",
                      }),
                    }),
                    e.jsx(i, {
                      value: "tab3",
                      children: e.jsx("div", {
                        className:
                          "p-6 bg-[var(--theme-primary)]/10 rounded-b-lg border-2 border-t-0 border-[var(--theme-primary)]",
                        children: "Sisältö käänteisen teeman välilehdelle 3.",
                      }),
                    }),
                  ],
                }),
          ...
          e.jsxs(j, {
            ...
            className: "p-8 rounded-lg shadow-lg",
            children: [
              e.jsx(k, { children: e.jsx(w, { children: "Tumma pääteema" }) }),
              e.jsx(N, {
                children: e.jsxs(x, {
                  defaultValue: "tabA",
                  children: [
                    e.jsxs(A, {
                      children: [
                        e.jsx(s, { value: "tabA", children: "Tumma tila A" }),
                        e.jsx(s, { value: "tabB", children: "Tumma tila B" }),
                      ],
                    }),
                    e.jsx(i, {
                      value: "tabA",
                      children: e.jsx("p", {
                        ...
                        children: "Tumma pääteema on aktiivinen. Värit mukautuvat saumattomasti.",
                      }),
                    }),
                    e.jsx(i, {
                      value: "tabB",
                      children: e.jsx("p", {
                        className: "mt-4 text-lg",
                        children: "Toinen testivälilehden sisältöpaneeli.",
                      }),
                    }),
                  ],
                }),
...
const te = ["Default", "Themed"];
export { L as Default, V as Themed, te as __namedExportsOrder, ee as default };

...
import { R as m } from "./iframe-RLsCwdXb.js";
import { c as p } from "./Button-eGzUney-.js";
import "./preload-helper-PPVm8Dsz.js";
import "./bundle-mjs-Ce1ZTWB2.js";
const s = m.forwardRef(({ className: l, label: o, error: n, theme: i, ...c }, d) =>
  e.jsxs("div", {
    ...
    children: [
      o &&
        e.jsx("label", {
          className: "text-sm font-black uppercase tracking-widest text-[var(--theme-secondary)]",
          children: o,
        }),
      e.jsx("input", {
        ref: d,
        className: p(
          ...
          n && "border-[var(--theme-accent)] focus-visible:ring-[var(--theme-accent)]",
          l,
        ),
        ...c,
      }),
      n &&
        e.jsx("span", {
          className: "text-sm font-bold uppercase tracking-widest text-[var(--theme-accent)]",
          children: n,
        }),
    ],
  }),
...
const f = {
  ...
  a = { args: { label: "Hahmon Nimi", placeholder: "Esim. Kaelen" } },
  t = { args: { label: "Koodi", placeholder: "Syötä koodi", error: "Koodi on virheellinen." } };
r.parameters = {
  ...r.parameters,
  docs: {
    ...r.parameters?.docs,
...
const y = ["Default", "WithLabel", "WithError"];
export { r as Default, t as WithError, a as WithLabel, y as __namedExportsOrder, f as default };

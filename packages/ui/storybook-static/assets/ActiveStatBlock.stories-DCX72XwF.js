...
import { R as B, r as q } from "./iframe-RLsCwdXb.js";
import { c as x, B as f } from "./Button-eGzUney-.js";
import { I as i } from "./Icon-dO9IW84r.js";
import { u as A, T as z, p as P } from "./Theme-9Lj_OJ7_.js";
import { H as K, a as C } from "./Heading-DaMVR3YC.js";
    ...
    return e.jsx(z.Provider, {
      ...
      children: e.jsxs("div", {
        ...
        className: x(
          ...
          {
            "bg-[var(--theme-bg)] text-[var(--theme-text)]": n === "primary",
        ...
        children: [
          e.jsxs(K, {
            children: [
              e.jsxs("div", {
                className: x("flex items-center gap-3 pb-3 border-b border-current/20", {
                  "border-b-[var(--theme-secondary)]": n === "secondary",
                  "border-b-[var(--theme-accent)]": n === "accent",
                }),
                children: [
                  l && e.jsx(i, { name: l, size: 24, className: "shrink-0" }),
                  e.jsx(C, { children: r }),
                ],
              }),
              e.jsxs("div", {
                ...
                children: [
                  e.jsx(f, {
                    ...
                    onClick: j,
                    disabled: t <= T,
                    "aria-label": `Vähennä ${r}`,
                    children: e.jsx(i, { name: "minus", size: 16 }),
                  }),
                  e.jsxs("div", {
                    className: "flex items-baseline gap-1 mx-4",
                    children: [
                      e.jsx("span", {
                        className:
                          "text-4xl text-[var(--theme-text)] font-heading font-black leading-none",
                        children: t,
                      }),
                      g !== void 0 &&
                        e.jsxs("span", {
                  ...
                  e.jsx(f, {
                    ...
                    disabled: t >= (g ?? S),
                    "aria-label": `Lisää ${r}`,
                    children: e.jsx(i, { name: "plus", size: 16 }),
                  }),
                ],
              }),
            ],
          }),
          l && e.jsx(i, { name: l, size: 128, className: "-top-6 -left-6 absolute opacity-5" }),
        ],
      }),
    });
  },
);
v.displayName = "ActiveStatBlock";
v.__docgenInfo = {
  description: "",
  methods: [],
  displayName: "ActiveStatBlock",
  props: {
...
const O = {
  ...
  s = (a) => {
    const [r, t] = q.useState(a.value || 0);
    return e.jsx(v, { ...a, value: r, onIncrement: () => t(r + 1), onDecrement: () => t(r - 1) });
  },
  o = {
    render: (a) => e.jsx(s, { ...a }),
    args: { label: "Terveys", value: 10, maxValue: 20, icon: "zap" },
  },
  c = { render: (a) => e.jsx(s, { ...a }), args: { label: "Panssari", value: 5, icon: "book" } },
  m = {
    render: (a) => e.jsx(s, { ...a }),
    args: { label: "Kestävyys", value: 100, maxValue: 100 },
  },
  d = {
    render: (a) => e.jsx(s, { ...a }),
    args: { label: "Taikapisteet", value: 15, maxValue: 50, variant: "accent", icon: "sparkles" },
  },
  u = {
    render: (a) => e.jsx(s, { ...a }),
    args: { label: "Kesto", value: 8, maxValue: 12, variant: "primary", icon: "shield" },
  },
  p = {
    render: () => {
      const a = [
      ...
      return e.jsx("div", {
        ...
        children: a.map((r) =>
          e.jsx(s, { theme: r, label: r, value: 10, maxValue: 20, icon: "sparkles" }, r),
        ),
      });
    },
    args: { label: "Teema", value: 10 },
  };
o.parameters = {
  ...o.parameters,
  docs: {
...
const F = ["Default", "NoMaxValue", "WithoutIcon", "Accent", "Primary", "ThemeShowcase"];
export {
  d as Accent,
  o as Default,
  c as NoMaxValue,

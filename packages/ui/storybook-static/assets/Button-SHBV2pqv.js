import { R as Ve } from "./index-mTzoL55G.js";
import { j as Ee } from "./jsx-runtime-u17CrQMm.js";
...
const Fe = (e, t) => {
  ...
  We = (e, t) => ({ classGroupId: e, validator: t }),
  ve = (e = new Map(), t = null, r) => ({ nextPart: e, validators: t, classGroupId: r }),
  K = "-",
  fe = [],
  _e = "arbitrary..",
  $e = (e) => {
    ...
    return {
      getClassGroupId: (a) => {
        if (a.startsWith("[") && a.endsWith("]")) return Ue(a);
        const b = a.split(K),
  ...
  eo = (e) => {
    ...
    if (t) {
      const i = t + ge,
        m = o;
      o = (a) => (a.startsWith(i) ? m(a.slice(i.length)) : he(Ze, !1, a, void 0, !0));
    }
    if (r) {
      const i = o;
  ...
  ro = (e) => ({ cache: Qe(e.cacheSize), parseClassName: eo(e), sortModifiers: oo(e), ...$e(e) }),
  to = /\s+/,
  so = (e, t) => {
    const {
        parseClassName: r,
    ...
    for (let u = b.length - 1; u >= 0; u -= 1) {
      ...
      const $ = A.length === 0 ? "" : A.length === 1 ? A[0] : m(A).join(":"),
        F = P ? $ + se : $,
        E = F + T;
  ...
  no = (...e) => {
    let t = 0,
      ...
      o,
      i = "";
    for (; t < e.length; ) (r = e[t++]) && (o = Ae(r)) && (i && (i += " "), (i += o));
    return i;
  },
  Ae = (e) => {
  ...
  ao = (e, ...t) => {
    ...
    const a = (d) => {
        ...
        return (r = ro(u)), (o = r.cache.get), (i = r.cache.set), (m = b), b(d);
      },
      b = (d) => {
        const u = o(d);
        if (u) return u;
  ...
  bo = /^(inset_)?-?((\d+)?\.?(\d+)[a-z]+|0)_-?((\d+)?\.?(\d+)[a-z]+|0)/,
  uo =
  ...
  Io = () => {
    const e = f("color"),
      ...
      c = () => [e, n, s],
      de = () => [...E(), ye, we, { position: [n, s] }],
      me = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }],
      pe = () => ["auto", "cover", "contain", Co, wo, { size: [n, s] }],
      oe = () => [te, _, O],
      x = () => ["", "none", "full", u, n, s],
      w = () => ["", p, _, O],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: ["auto", "square", R, s, n, y] }],
        container: ["container"],
        ...
        w: [{ w: [b, "screen", ...N()] }],
        "min-w": [{ "min-w": [b, "screen", "none", ...N()] }],
        "max-w": [{ "max-w": [b, "screen", "none", "prose", { screen: [a] }, ...N()] }],
        h: [{ h: ["screen", "lh", ...N()] }],
        "min-h": [{ "min-h": ["screen", "lh", "none", ...N()] }],
        "max-h": [{ "max-h": ["screen", "lh", ...N()] }],
        "font-size": [{ text: ["base", r, _, O] }],
        "font-smoothing": ["antialiased", "subpixel-antialiased"],
        "font-style": ["italic", "not-italic"],
        "font-weight": [{ font: [o, So, yo] }],
        "font-stretch": [
          {
            "font-stretch": [
              "ultra-condensed",
        ...
        "text-decoration-thickness": [{ decoration: [p, "from-font", "auto", n, O] }],
...
const Le = Ve.forwardRef(({ className: e, variant: t = "primary", ...r }, o) =>
  Ee.jsx("button", {
    ref: o,
    className: Po(
      ...
      "h-10 px-4 py-2",
      {
        "bg-orange-500 text-black hover:bg-orange-400": t === "primary",
        "bg-slate-800 text-slate-100 hover:bg-slate-700": t === "secondary",
        "bg-red-600 text-white hover:bg-red-500": t === "danger",
      },
      e,
    ),
    ...r,
